...
add.place(x=228,y=98)

sub=Button(width=8,height=1,text="-",bg="#E8F1FF",fg="#004AEC", font=("Malgun Gothic",16), relief="groove", command=lambda: click("-"))
sub.place(x=228,y=156)

mul=Button(width=8,height=1,text="x",bg="#E8F1FF",fg="#004AEC", font=("Malgun Gothic",16), relief="groove", command=lambda: click("*"))
mul.place(x=228,y=214)

div=Button(width=8,height=1,text="÷",bg="#E8F1FF",fg="#004AEC", font=("Malgun Gothic",16), relief="groove", command=lambda: click("/"))
div.place(x=228,y=272)

result=Button(width=8,height=1,text="=",fg="#FF1555", font=("Malgun Gothic",16), relief="groove", command=solution)
result.place(x=228,y=330)

back_space = Button(width=8,height=1,text="Del",bg="#E8F1FF",fg="#004AEC", font=("Malgun Gothic",16), relief="groove", command=one_by_one)
back_space.place(x=228,y=40)
